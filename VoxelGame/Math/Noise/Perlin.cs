// SOURCE: https://github.com/ddevault/TrueCraft/blob/master/TrueCraft.Core/TerrainGen/Noise/Perlin.cs
...
namespace VoxelGame.Noise
{
    ...
    public class Perlin : NoiseGen
    {
        ...
        public override double Value2D(double X, double Y)
        {
            ...
            {
                Total += Interpolated2D(X / Scale * _Frequency, Y / Scale * _Frequency) * _Amplitude;
        ...
        public override double Value3D(double X, double Y, double Z)
        {
            ...
            for (int I = 0; I < Octaves; I++)
            {
                Total += Interpolated3D(X / Scale * _Frequency, Y / Scale * _Frequency, Z / Scale * _Frequency) * _Amplitude;
                _Frequency *= Lacunarity;
                _Amplitude *= Persistance;
            }
            return Total;
