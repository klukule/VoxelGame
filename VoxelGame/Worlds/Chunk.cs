...
namespace VoxelGame.Worlds
{
    ...
    public partial class Chunk : IDisposable
    {
        ...
        /*public byte GetBlockLightRaw(int x, int y, int z)
        {
            ...
            {
                if (LeftNeighbor != null)
                    return LeftNeighbor.GetBlockLightRaw(WIDTH + x, y, z);
            ...
            {
                if (RightNeighbor != null)
                    return RightNeighbor.GetBlockLightRaw(x - WIDTH, y, z);
            ...
            {
                if (BackNeighbor != null)
                    return BackNeighbor.GetBlockLightRaw(x, y, WIDTH + z);
            ...
            {
                if (FrontNeighbor != null)
                    return FrontNeighbor.GetBlockLightRaw(x, y, z - WIDTH);
        ...
        public void SetBlockLight(int x, int y, int z, byte light)
        {
            ...
            {
                if (LeftNeighbor != null)
                    LeftNeighbor.SetBlockLight(WIDTH + x, y, z, light);
            }
            else if (x >= WIDTH)
            {
                if (RightNeighbor != null)
                    RightNeighbor.SetBlockLight(x - WIDTH, y, z, light);
            }
            else if (z <= -1)
            {
                if (BackNeighbor != null)
                    BackNeighbor.SetBlockLight(x, y, WIDTH + z, light);
            }
            else if (z >= WIDTH)
            {
                if (FrontNeighbor != null)
                    FrontNeighbor.SetBlockLight(x, y, z - WIDTH, light);
            }
